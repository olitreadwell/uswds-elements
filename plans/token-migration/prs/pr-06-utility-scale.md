...
1. **`tokens/system/z-index/z-index.json`**
   ...
   ```json
   {
     "z-index": {
       "$type": "number",
       "bottom":  { "$value": -100,  "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-z-index-bottom"] } } },
       "0":       { "$value": 0,     "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-z-index-0"] } } },
       "100":     { "$value": 100,   "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-z-index-100"] } } },
       "200":     { "$value": 200,   "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-z-index-200"] } } },
       "300":     { "$value": 300,   "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-z-index-300"] } } },
       "400":     { "$value": 400,   "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-z-index-400"] } } },
       "500":     { "$value": 500,   "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-z-index-500"] } } },
       "top":     { "$value": 99999, "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-z-index-top"] } } },
       "auto":    { "$value": "auto","$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-z-index-auto"] } } }
     }
   }
   ```
...
3. **`tokens/system/shadow/shadow.json`** — 6 entries. Box-shadow values from the CSV
   ...
   ```json
   {
     "shadow": {
       "$type": "string",
       "none": { "$value": "none",                                   "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-box-shadow-none"] } } },
       "1":    { "$value": "0 1px 0.25rem 0 rgba(0, 0, 0, 0.1)",   "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-box-shadow-1"] } } },
       "2":    { "$value": "0 0.25rem 0.5rem 0 rgba(0, 0, 0, 0.1)","$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-box-shadow-2"] } } },
       "3":    { "$value": "0 0.5rem 1rem 0 rgba(0, 0, 0, 0.1)",   "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-box-shadow-3"] } } },
       "4":    { "$value": "0 0.75rem 1.5rem 0 rgba(0, 0, 0, 0.1)","$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-box-shadow-4"] } } },
       "5":    { "$value": "0 1rem 2rem 0 rgba(0, 0, 0, 0.1)",     "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-box-shadow-5"] } } }
     }
   }
   ```
...
5. **`tokens/system/gap/gap.json`** — numeric gaps aliased into spacing where they
   ...
   ```json
   {
     "gap": {
       "$type": "dimension",
       "0":   { "$value": { "value": 0, "unit": "" },    "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-0"] } } },
       "2px": { "$value": { "value": 2, "unit": "px" },  "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-2px"] } } },
       "05":  { "$value": "{spacing.05}",                "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-05"] } } },
       "1":   { "$value": "{spacing.1}",                 "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-1"] } } },
       "2":   { "$value": "{spacing.2}",                 "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-2"] } } },
       "3":   { "$value": "{spacing.3}",                 "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-3"] } } },
       "4":   { "$value": "{spacing.4}",                 "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-4"] } } },
       "5":   { "$value": "{spacing.5}",                 "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-5"] } } },
       "6":   { "$value": "{spacing.6}",                 "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-6"] } } },
       "sm":  { "$value": "{gap.2px}",                   "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-sm"] } } },
       "md":  { "$value": "{gap.2}",                     "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-md"] } } },
       "lg":  { "$value": "{gap.3}",                     "$extensions": { "uswds": { "tier": "system", "legacyName": ["$system-gap-lg"] } } }
     }
   }
   ```
